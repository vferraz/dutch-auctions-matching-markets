...
def main():
    base_out = "variants_out"
    os.makedirs(base_out, exist_ok=True)

    for variant in ("TIMING_ONLY", "TRADEOFF_CASE"):
        outdir = os.path.join(base_out, variant.lower())
        run_variant(variant, outdir, D_grid=(20,40,60), R_grid=(20,40,60), n_rep=10, seed0=1234)
